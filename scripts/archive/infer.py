import sys; sys.path.append('/opt/YuE/inference/xcodec_mini_infer')
import os
import sys
...
if raw_output is None: raise ValueError("ERROR CRITICO: El Stage 1 no genero ningun token. Revisa el formato de tus letras.") # Patch
if raw_output is None: raise ValueError("Stage 1 falló");
if raw_output is None: raise ValueError("Stage 1 falló");
if raw_output is None: raise ValueError("Stage 1 no generó nada");
