...
try:
    ...
    print(f"Subiendo {LOCAL_FILE} a /home/pepe/documusic/backend/main.py...")
    sftp.put(LOCAL_FILE, "/home/pepe/documusic/backend/main.py")
    sftp.close()
    ...
    print("Despliegue V2 Final completado.")
    client.close()
